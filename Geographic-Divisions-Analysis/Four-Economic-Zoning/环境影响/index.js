window.onload = function () {
    ...
    for (var k of data) {
        ...
        for (var x of map_data) {
            if (x.name === k[5]) {
                x.value = x.value + parseInt(k[7]) + 10000;
                break;
            }
        }
    }
    ...
    for (var x of map_data) {
        ...
        // x.value=x.value*x.value*x.value*x.value*10;
        console.log(x.name + " " + x.value);
        //console.log(x.name+" "+x.value);
    }
    ...
    for (var x of map_data) {
      x.value=x.value*x.value*x.value*25;
    //   console.log(x.name + " " + x.value);
    //   x.value *= 200;
    }
    // mapChart的配置
